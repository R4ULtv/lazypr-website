...
1. [Install LazyPR](/docs/introduction/installation) in under 1 minute
2. [Create your first PR](/docs/introduction/quick-start) in seconds
3. [Configure providers](/docs/configuration/providers) to match your needs
