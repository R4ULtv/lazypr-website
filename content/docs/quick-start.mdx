...
<Cards>
  ...
  <Card title="AI Providers" href="/docs/config/providers" description="Choose AI providers and customize your settings" />
  <Card title="Usage Guide" href="/docs/usage/basic-commands" description="Learn all the commands and options" />
  <Card title="Examples" href="/docs/examples/cli-usage" description="See real-world examples and workflows" />
</Cards>
